...
![Header](https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,12,20&height=200&section=header&text=Mohamed%20Fadl&fontSize=60&fontColor=fff&animation=twinkling&fontAlignY=35&desc=Front-End%20Developer%20%7C%20Clean%20Code%20Craftsman&descSize=18&descAlignY=55)
...
const mohamed = {
  ...
  technologies: {
    ...
    currentFocus: "Building scalable, accessible web applications"
  }
};
```
